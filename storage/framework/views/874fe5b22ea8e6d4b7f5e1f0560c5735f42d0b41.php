              ...
              <div class="col-xs-12">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody class="contentDefaultAttribute">
						...
						<tr>
							<td colspan="5"><strong>
				    		<?php echo e(trans('labels.NoRecordFoundTextForDefaultOption')); ?>
				...
				<div class="modal fade" id="adddefaultattributesmodal" tabindex="-1" role="dialog" aria-labelledby="addAttributeModalLabel">
				  <div class="modal-dialog" role="document">
					<div class="modal-content">
					  ...
					  <?php echo Form::open(array('url' =>'admin/addnewdefaultattribute', 'name'=>'addattributefrom', 'id'=>'adddefaultattributefrom', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>
...
<div class="row">
      <div class="col-md-12">
				...
				<div class="modal fade" id="addAttributeModal" tabindex="-1" role="dialog" aria-labelledby="addAttributeModalLabel">
				  <div class="modal-dialog" role="document">
					<div class="modal-content">
					  ...
					  <?php echo Form::open(array('url' =>'admin/addnewproductattribute', 'name'=>'addattributefrom', 'id'=>'addattributefrom', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')); ?>
        ...
        <div class="box-footer text-center">
                ...
                <a href="<?php echo e(URL::to("admin/addinventory/{$result['data']['products_id']}")); ?>" class="btn btn-primary pull-right"><?php echo e(trans('labels.Add Stock')); ?> <i class="fa fa-angle-right"></i> </a>
		</div>
