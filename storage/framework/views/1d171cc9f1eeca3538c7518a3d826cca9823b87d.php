    ...
    <div class="row">
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="<?php echo e(URL::to('admin/orders')); ?>" class="small-box-footer" data-toggle="tooltip" data-placement="bottom" title="<?php echo e(trans('labels.viewAllOrders')); ?>"><?php echo e(trans('labels.viewAllOrders')); ?> <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-4 col-xs-6">
        ...
        <div class="col-md-8">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-danger">
                ...
                <div class="box-footer text-center">
                  <a href="<?php echo e(URL::to('admin/customers')); ?>" class="uppercase" data-toggle="tooltip" data-placement="bottom" title="View All Customers"><?php echo e(trans('labels.viewAllCustomers')); ?></a>
                </div>
                <!-- /.box-footer -->
              </div>
              <!--/.box -->
          ...
          <div class="box box-info">
            ...
            <div class="box-footer clearfix">
              ...
              <a href="<?php echo e(URL::to('admin/orders')); ?>" class="btn btn-sm btn-default btn-flat pull-right" data-toggle="tooltip" data-placement="bottom" title="View All Orders"><?php echo e(trans('labels.viewAllOrders')); ?></a>
            </div>
            <!-- /.box-footer -->
          </div>
          <!-- /.box -->
