                          ...
                          <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown dropdown-main">
                              ...
                              <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink00">          
                                <?php $__currentLoopData = $result['commonContent']['categories']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categories_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>            
                                    <li>                
                                        <a class="dropdown-item" href="<?php echo e(URL::to('/shop')); ?>?category=<?php echo e($categories_data->slug); ?>"><img class="img-fuild" src="<?php echo e(asset('').$categories_data->icon); ?>"><?php echo e($categories_data->name); ?> 
                                         <?php if(count($categories_data->sub_categories)>0): ?>
                                        ...
                                        <ul class="dropdown-menu dropdown-submenu">
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="<?php echo e(URL::to('/shop')); ?>?category=<?php echo e($sub_categories_data->sub_slug); ?>"><img class="img-fuild" src="<?php echo e(asset('').$sub_categories_data->sub_icon); ?>"><?php echo e($sub_categories_data->sub_name); ?></a></li>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                                        </ul>
                                    <?php endif; ?>
                                    </li>
