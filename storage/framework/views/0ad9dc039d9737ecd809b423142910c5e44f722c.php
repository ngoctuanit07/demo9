...
<section class="site-content">
    ...
    margin-right: 0;">
                                ...
                                <div class="product-summary">
                                	...
                                	<?php if(!empty($result['detail']['product_data'][0]->flash_start_date)): ?>
                                                ...
                                                <?php if( $result['detail']['product_data'][0]->server_time >= $result['detail']['product_data'][0]->flash_start_date): ?>
                                                   <span style="display: none" id="counter_product"></span>											<?php endif; ?>
                                                 </div>                                            
                                            <?php endif; ?> 
                                    ...
                                    <div class="product-price">
                                        ...
                                        <?php if($result['detail']['product_data'][0]->products_min_order>0): ?>
                                        	<span class="min-order-tag" <?php if(!empty($result['detail']['product_data'][0]->flash_start_date) and $result['detail']['product_data'][0]->server_time < $result['detail']['product_data'][0]->flash_start_date ): ?> style="display: none" <?php endif; ?>>
                                    ...
                                    <form name="attributes" id="add-Product-form" method="post" >
                                        ...
                                        <input type="hidden" name="products_price" id="products_price" value="<?php echo e($result['cart'][0]->final_price+0); ?>">
                                        <input type="hidden" name="checkout" id="checkout_url" value="true" >	
                                        <input type="hidden" name="cart_id" id="cart_id" value="<?php echo e(app('request')->input('id')); ?>">
                                                    ...
                                                    <div class="col-sm-12">								
                                                        ...
                                                        <select name="<?php echo e($attributes_data['option']['id']); ?>" onChange="getQuantity()" class="currentstock form-control attributeid_<?=$index++?>" attributeid = "<?php echo e($attributes_data['option']['id']); ?>">
                                                            <?php $__currentLoopData = $attributes_data['values']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $values_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
														   	...
														   	<option  attributes_value="<?php echo e($values_data['products_attributes_id']); ?>" 
															value="<?php echo e($values_data['id']); ?>" 
															prefix = '<?php echo e($values_data['price_prefix']); ?>'  
															value_price ="<?php echo e($values_data['price']+0); ?>" 
															<?php if(count($result['cart'][0]->attributes)>0): ?> <?php if(in_array($values_data['products_attributes_id'], $cart_attribiters)): ?>
															selected <?php endif; ?> <?php endif; ?> ><?php echo e($values_data['value']); ?></option>								
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>								
                                                        </select>								
                                                    </div>							
                                                </div>
                                        ...
                                        <div class="form-inline product-box">
                                            <div class="form-group Qty">	
                                                ...
                                                <div class="input-group">						
                                                    ...
                                                    <input type="text" readonly name="quantity" value="<?php echo e($result['cart'][0]->customers_basket_quantity); ?>" min="<?php echo e($min_order_limit); ?>" max="<?php echo e($max_order_limit); ?>" class="form-control qty">											
                                            ...
                                            <div class="price-box">
                                                ...
                                                <span class="total_price">
                                                    <!--<?php if(!empty($result['detail']['product_data'][0]->flash_price)): ?>
                                                        <?php echo e($web_setting[19]->value); ?><?php echo e($result['detail']['product_data'][0]->flash_price+0); ?>                                                	<?php elseif(!empty($result['detail']['product_data'][0]->discount_price)): ?>
                                                        <?php echo e($web_setting[19]->value); ?><?php echo e($result['detail']['product_data'][0]->discount_price+0); ?>
                                                    ...
                                                    <?php endif; ?>-->
                                                    <?php echo e($web_setting[19]->value); ?><?php echo e($result['cart'][0]->final_price*$result['cart'][0]->customers_basket_quantity); ?>
                                            ...
                                            <div class="buttons" style="margin-top:30px;">
                                                ...
                                                <?php if($result['detail']['product_data'][0]->products_type == 0): ?>                                        	
                                                    ...
                                                    <?php else: ?> 
                                                        <button class="btn btn-secondary update-single-Cart" type="button" products_id="<?php echo e($result['detail']['product_data'][0]->products_id); ?>"><?php echo app('translator')->getFromJson('website.Update'); ?></button>
                                                    <?php endif; ?>
                                                    
                                                <?php else: ?>
                                                     <button class="btn btn-secondary update-single-Cart stock-cart"  hidden type="button" products_id="<?php echo e($result['detail']['product_data'][0]->products_id); ?>"><?php echo app('translator')->getFromJson('website.Update'); ?></button>                                                    
                    ...
                    <div class="related-product-area">
                    	<div class="heading">
                            <h2><?php $__currentLoopData = $result['detail']['product_data'][0]->categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(++$key === 1): ?>
