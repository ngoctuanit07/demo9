        ...
        <div class="box">
          <div class="box-header">
            ...
            <div class="box-tools pull-right">
            	<a href="<?php echo e(URL::to('admin/addcustomers')); ?>" type="button" class="btn btn-block btn-primary"><?php echo e(trans('labels.AddNewCustomers')); ?></a>
            </div>
          </div>
              ...
              <div class="col-xs-12">
						...
						<?php $__currentLoopData = $customers['result']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$listingCustomers): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<tr>
								...
								<td>
									...
									<strong><?php echo e(trans('labels.Email')); ?>: </strong> <?php echo e($listingCustomers->email); ?> <br>
                              ...
                              <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="editcustomers/<?php echo e($listingCustomers->customers_id); ?>"><?php echo e(trans('labels.EditCustomers')); ?></a></li>
                                    <li role="presentation" class="divider"></li>
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="addaddress/<?php echo e($listingCustomers->customers_id); ?>"><?php echo e(trans('labels.EditAddress')); ?></a></li>
                                    <li role="presentation" class="divider"></li>
                                    <li role="presentation"><a data-toggle="tooltip" data-placement="bottom" title="<?php echo e(trans('labels.Delete')); ?>" id="deleteCustomerFrom" customers_id="<?php echo e($listingCustomers->customers_id); ?>"><?php echo e(trans('labels.Delete')); ?></a></li>
                                </ul>
                              </li>
                            </ul>
								</td>
                ...
                <?php if(count($customers['result']) > 0): ?>
					<div class="col-xs-12 text-right">
						<?php echo e($customers['result']->links('vendor.pagination.default')); ?>
