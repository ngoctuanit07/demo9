...
<span> <?php echo e(trans('labels.Manage Admins')); ?></span> <i class="fa fa-angle-left pull-right"></i>
          ...
          <ul class="treeview-menu">
            ...
            <li class="<?php echo e(Request::is('admin/categoriesroles') ? 'active' : ''); ?> <?php echo e(Request::is('admin/categoriesroles') ? 'active' : ''); ?> <?php echo e(Request::is('admin/categoriesroles/*') ? 'active' : ''); ?>"><a href="<?php echo e(URL::to('admin/categoriesroles')); ?>"><i class="fa fa-circle-o"></i> <?php echo e(trans('labels.link_categoriesroles')); ?></a></li>
