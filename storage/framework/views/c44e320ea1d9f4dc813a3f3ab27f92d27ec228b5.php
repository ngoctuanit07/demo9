      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><?php echo e(trans('labels.ListingConstantBanners')); ?> </h3>
            ...
            <div class="row">
              <div class="col-xs-12">
                <table id="example1" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      ...
                      <th><?php echo e(trans('labels.Side Banner')); ?></th>
                ...
                <div class="col-xs-12 text-right">
                	<?php echo e($result['banners']->links('vendor.pagination.default')); ?>
