                         ...
                         <div class="box-body">
                            ...
                            <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    ...
                                    <?php $__currentLoopData = $result['adminTypes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $adminType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <option value="<?php echo e($adminType->admin_type_id); ?>"><?php echo e($adminType->admin_type_name); ?></option>
                            ...
                            <hr>
                              ...
                              <div class="box-footer text-center">
                                <button type="submit" class="btn btn-primary"><?php echo e(trans('labels.addadmin')); ?></button>
