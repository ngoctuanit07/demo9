...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ URL::to('admin/coupons')}}"><i class="fa fa-tablet"></i>{{ trans('labels.ListingAllCoupons') }}</a></li>
              	  ...
              	  <div class="box box-info"><br>                                   
                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                            ...
                            {!! Form::open(array('url' =>'admin/addnewcoupons', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
									{!! Form::text('expiry_date',  '', array('class'=>'form-control field-validate coupondatepicker', 'id'=>'', 'readonly'=>'readonly'))!!}
							...
							<div class="box-footer text-center">
								<button type="submit" class="btn btn-primary">{{ trans('labels.AddCoupons') }}</button>
