                  ...
                  @if(count($result['languages'])>0)
                    @foreach ($result['languages'] as $key=>$languages)
                        <tr>
                            ...
                            <td>
                            	<a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Edit') }}" href="{{ URL::to('admin/editlanguages/'.$languages->languages_id)}}" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
                                
                                @if($languages->languages_id!=1 and $languages->is_default==0) 
                            	<a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Delete') }}" id="deleteLanguageId" languages_id ="{{ $languages->languages_id }}" class="badge bg-red"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                @endif
                           </td>
                        </tr>
                    @endforeach
