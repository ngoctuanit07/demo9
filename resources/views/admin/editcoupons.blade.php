              	  ...
              	  <div class="box box-info"><br>
                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                            ...
                            {!! Form::open(array('url' =>'admin/updatecoupons', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
									{!! Form::text('expiry_date',  date('m/d/Y', strtotime($result['coupon'][0]->expiry_date)), array('class'=>'form-control field-validate coupondatepicker', 'id'=>'', 'readonly'=>'readonly'))!!}
