                            ...
                            {!! Form::open(array('url' =>'admin/addnewtype', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    {!! Form::text('admin_type_name',  '', array('class'=>'form-control field-validate', 'id'=>'admin_type_name')) !!}
                              ...
                              <div class="box-footer text-center">
                                <button type="submit" class="btn btn-primary">{{ trans('labels.AddAdminType') }}</button>
