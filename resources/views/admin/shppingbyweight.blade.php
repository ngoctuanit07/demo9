                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                          ...
                          @endif
                            ...
                            {!! Form::open(array('url' =>'admin/updateShppingWeightPrice', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
                            ...
                            <div class="box-footer">
								<a href="{{ URL::to('admin/shippingmethods')}}" type="button" class="btn btn-default pull-left"> <i class="fa fa-angle-left"></i> {{ trans('labels.back') }}</a>
