              	  ...
              	  <div class="box box-info"><br>
                	 @if (count($errors) > 0)
                      ...
                      @endif
                        ...
                        <div class="box-body">                         
                            {!! Form::open(array('url' =>'admin/updatevalue', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
							...
							<div class="box-footer text-center">
								...
								<a href="{{ URL::to("admin/manage-options-values/".$result['editoptions'][0]->products_options_id)}}" type="button" class="btn btn-default">{{ trans('labels.back') }}</a>
							</div>
